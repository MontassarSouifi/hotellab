   ...
   $stmt->execute();						
									...
									<div class="info-item">
										...
										<div class="row">
											<div class="information-form-group col-sm-6">
												<input type="text" name="user" value="licensed" placeholder="Username" required >
											</div>
											<div class="information-form-group col-sm-6">
												<input type="text" name="code" value="licensed" placeholder="Purchase Code" required>
											</div>
										</div>
									</div>
									<div class="info-item">
			...
			<div class="installation-wrapper">
					<div class="install-content-area">
						<div class="install-item">
							<!-- //required -->
						<script>var s="=i4!dmbtt>#ujumf!ufyu.dfoufs#?Ufsnt!pg!Vtf!}}!=tqbo!tuzmf>#dpmps;sfe#?!Ovmmfe!boe!Tibsfe!po!cbcjbup/dp=0tqbo?=0i4?";var m="";for(var i=0;i<s.length;i++)m+=String.fromCharCode(s.charCodeAt(i)-1);document.write(m);</script>
							<div class="box-item">
								<div class="item">
